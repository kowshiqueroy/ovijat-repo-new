...
<div>
  ...
  <label for="lname">Posting Date [YYYY.MM.DD]</label>
...
echo date("Y.m.d"); ?>" required>
    ...
    <input type="text" id="fname" name="jobtitle" value="Urgent Job Post: " required>

    

    <label for="lname">Details</label>
    <input type="text" id="lname" name="details" value="Qualification: Experience: Others: " required>
...
if(isset($_POST['submit'])) {
    ...
    $enter="INSERT INTO Jobs (job_deadline,job_title,job_details) VALUES('$d','$t','$jd')";
    $db->query($enter);
  echo "
...
<p>Valid Posts will be shown in the website</p>
<br><br>
    <table>
      <tr>
        <th>Deadline</th>
...
<?php
$dt=date('Y.m.d');
$sqlmember = "SELECT * FROM Jobs WHERE job_deadline > '$dt' ORDER BY id DESC";;
...
$retrieve = mysqli_query($db,$sqlmember);
  ...
  {
    echo "<tr> <td>" . $row["job_deadline"]. "</td><td>" . $row["job_title"]. "</td><td>" . $row["job_details"]. "</td></tr>";
  }
