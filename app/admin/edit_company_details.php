 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update tblcompany set DetailsName = '$deptname' , Details ='$deptshortname' where id = '$get_id' ");
    if ($result) {
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									<?php
									$query = mysqli_query($conn,"SELECT * from tblcompany where id = '$get_id'")or die(mysqli_error());
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="departmentname" type="text" class="form-control" required="true" autocomplete="off" value="<?php echo $row['DetailsName']; ?>">
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<input name="departmentshortname" type="text" class="form-control" required="true" autocomplete="off"  value="<?php echo $row['Details']; ?>">
											</div>
										</div>
									</div>
