...
<center>
        <h2>MRR</h2>
        <form action="mrr.php" method="get">
        ...
        <input style="width:0px; height:0px; opacity:0;" type="submit">
            ...
            <table id="dt" class="table table-striped" style="font-size:15px;">
                ...
                $select = $pdo->prepare("select * from entry where entrytime >= '$from' and entrytime <= '$to' and (type ='In' or type ='Purchase' or type ='Lend Return' or type ='Sell Return' or type ='Gift Return') order by id desc");
