...
if(isset($_POST["btnsaveorder"])){
   // $datee=$_POST['orderdate'];
    ...
    $insert=$pdo->prepare("insert into tbl_in_info(customer_name,order_date,order_time,subtotal,tax,discount,total,paid,due,payment_type) values(:cust,:orderdate,:ordertime,:stotal,:tax,:disc,:total,:paid,:due,:ptype)");
    ...
    if($invoice_id !=null){
        ...
        for($i=0 ; $i<count($arr_productid); $i++){
            ...
            $insert=$pdo->prepare("insert into tbl_in_data(invoice_id,item_id,item_name,qty,price,order_date,order_time)values(:invid,:pid,:pname,:qty,:price,:orderdate,:ordertime)");
