              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                while($row=$select->fetch(PDO::FETCH_OBJ)){
                  ...
                  echo "
                    ...
                    <td><button input type=\"submit\" value=" .$row->catid."\"  class=\"btn btn-danger\" name=\"btndelete\"><span class=\"fas fa-trash\"   style=\"color:#ffffff\" data-toggle=\"tooltip\" title=\"DELETE\"></span></button></td>
