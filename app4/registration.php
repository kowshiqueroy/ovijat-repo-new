              ...
              <form role="form" action="" method="post">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter User Name to be added" name="txtregname"
                      required>
                  </div>

                  <div class="form-group">
                    <label for="exampleInputPassword1">Email</label>
                    <input type="text" class="form-control" placeholder="Enter Email to be added" name="txtregemail"
                      required>
                  </div>
...
<div class="card card-info">
  ...
  <table id="example2" class="table table-bordered table-hover">
          ...
          while($row=$select->fetch(PDO::FETCH_OBJ)){
              ...
              <td>$row->role</td>
              <td> <p>
              <a  href=\"forgotpassword.php?email=".$row->useremail."\" 
              class= \"btn btn-success\" role=\"button\" ><span class=\"fa fa-envelope \" name=\"dltBtn\" title=\"DELETE\"></span>
              </a>
