...
if(isset($_POST["btnsaveorder"])){
   // $datee=$_POST['orderdate'];
    ...
    $insert=$pdo->prepare("insert into tbl_in_info(customer_name,order_date,subtotal,tax,discount,total,paid,due,payment_type) values(:cust,:orderdate,:stotal,:tax,:disc,:total,:paid,:due,:ptype)");
